...
async def on_message(message):
    ...
    elif message.content == ('slist' or 'すりすと'):
        await message.channel.send('sreg / すしばり\nsrule / するーる\nsstage / すすて\nsbuki / すぶき\nssp / すすぺ\nssub / すさぶ\nsctg / すぶきしゅ')
    elif message.content == ('すぶき' or 'sbuki' or 'すぶき'):
    ...
    elif message.content == ('ssp' or 'すすぺ'):
    ...
    elif message.content == ('sreg' or 'すしばり'):
